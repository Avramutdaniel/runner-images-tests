...
$packageManagement.AddToolVersion("Checkov", $(Get-CheckovVersion))
...
$tools.AddToolVersion("Terragrunt", $(Get-TerragruntformVersion))
...
$softwareReport.ToJson() | Out-File -FilePath "/imagegeneration/software-report.json" -Encoding UTF8NoBOM
$softwareReport.ToMarkdown() | Out-File -FilePath "/imagegeneration/software-report.md" -Encoding UTF8NoBOM
